...
@section('breadcrumb', 'Transaksi / Barang Keluar / Edit')

@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-md">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-800">Form Edit Barang Keluar</h3>
            </div>

            <form action="{{ route('stock-out.update', $stockOut->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
