...
@section('header', 'Tambah Barang Keluar')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-md">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-800">Form Tambah Barang Keluar</h3>
            </div>

            <form action="{{ route('stock-out.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div id="item-info" class="mt-2 text-sm text-gray-600 hidden">
                        ...
                        <p><strong>Stok Tersedia:</strong> <span id="info-stock" class="font-bold text-green-600"></span> <span id="info-unit"></span></p>
                    </div>
                </div>
